    ...
    public void onBindViewHolder(ViewHolder card, int position) {
        ...
        switch (selectedTheme) {
            ...
            case R.style.AppTheme_Neutral:
                emojiForCircle = ResourcesCompat.getDrawable(context.getResources(), R.drawable.ic_grocery_15, null);
...
/* Title: LocationRecyclerViewAdapter source code
   Author: Lang Smith
   Availability: https://github.com/mapbox/store-locator-android/blob/master/StoreLocator/app/src/main/java/com/mapbox/storelocator/adapter/LocationRecyclerViewAdapter.java */
